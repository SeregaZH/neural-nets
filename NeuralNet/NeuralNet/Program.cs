    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var simpleLearn = new SimpleLearning(
                new PerceptronSettings(3, x => x , t => Math.Round(1/(1 + Math.Pow(Math.E, -t)), MidpointRounding.ToEven)),
                new SimpleLearningSettings(0.01),
            ...
            Console.WriteLine("Wx:{0}, Wy:{1}, Wz:{2}", weights[0], weights[1], weights[2]);
